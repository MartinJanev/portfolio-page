export const experience = [
  ...
  },
  {
    ...
    location: "Skopje, Macedonia",
    description:
      "Here I will gain problem-solving and critical thinking skills for tackling complex computational challenges. Specifically, I am getting prepared for careers in companies, research centers, and interdisciplinary projects, with a strong foundation for postgraduate studies and software development.",
    bullets: [
      ...
      "Starting to explore research opportunities in the fields taught in the faculty",
    ],
    tags: [
      "Computer Science",
      "Education",
